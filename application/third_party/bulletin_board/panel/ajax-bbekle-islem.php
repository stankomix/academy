...
$addsql = "INSERT INTO bulletin_board VALUES (null, '$title','$category','$content','$create_date','1')";
mysql_query($addsql);
$sonid = mysql_insert_id();

$pd_data = "select id from bb_photos where bb_id='$randomnumber' order by id desc";
$pd_sorgu = mysql_query($pd_data);
while ($pd = mysql_fetch_assoc($pd_sorgu)){
$bbeditsql = "UPDATE bb_photos SET bb_id='$sonid' WHERE id='$pd[id]'";

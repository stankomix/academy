...
if($photoid!=""){
$sqlcontrol=mysql_fetch_array(mysql_query("SELECT * FROM bb_galeri WHERE id='$photoid' "));

$deletesql = "UPDATE bb_galeri SET status = '2' WHERE id='$sqlcontrol[id]'";
mysql_query($deletesql);
}
?>
<script>
function takibikaldir(id){
$.post( "bb_fotoajax.php", {photoid:id} );
$("#tkbne"+id).remove();
}
</script>
<?
$tablosaydir=0;
$photos_data = "select * from bb_galeri where bb_id='$aid' and status='1' order by id desc";

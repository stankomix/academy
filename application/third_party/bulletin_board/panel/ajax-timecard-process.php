...
//$secenekeklesql = "INSERT INTO timesheets VALUES (null, '$title','$category','$content','$create_date','1')";

//get id from members
$strSQL = "INSERT INTO timesheets VALUES (null, $user_idtitle, $workorder_id,$start_time,$end_time)";
